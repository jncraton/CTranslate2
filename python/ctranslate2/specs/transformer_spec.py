...
class TransformerEncoderSpec(model_spec.LayerSpec):
    def __init__(
        ...
        Args:
          ...
          num_heads_kv: Number of key/value heads for grouped-query attention.
        ...
        self.layer = [
            TransformerEncoderLayerSpec(
                ...
                ffn_glu=ffn_glu,
                rms_norm=rms_norm,
                num_heads_kv=num_heads_kv if num_heads_kv is not None else (1 if multi_query_attention else None),
